...
CKPT_LOAD = False
CKPT_PATH ='/home/asim.ukaye/ml_proj/simclr_cxr/lightning_logs/version_33/checkpoints/last.ckpt'
...
model_pl = BYOL(base_encoder=base_model,  max_epochs=EPOCHS, encoder_out_dim=512)
